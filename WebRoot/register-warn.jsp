...
%>
<%!String warn1,warn2,warn3,warn5; %>
<%
warn1=(String)session.getAttribute("warn1");
warn2=(String)session.getAttribute("warn2");
warn3=(String)session.getAttribute("warn3");
warn5=(String)session.getAttribute("warn5");
if(warn1==null){
warn1="";}
if(warn2==null){
warn2="";}
...
if(warn5==null){
warn5="";}
session.removeAttribute("warn1");
session.removeAttribute("warn2");
session.removeAttribute("warn3");
session.removeAttribute("warn5");
%>
<!DOCTYPE jsp>
<jsp>
<head>
...
<body>
 ...
 <p style="margin:0px 0px 0px 50px;font-size:14px;color: #666666"><%=warn1+"    "+warn2+"    "+warn3+"    "+warn5%></p>
