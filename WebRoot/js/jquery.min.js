...
!function(a, b) {
    ...
    var s = function(a) {
        ...
        m = fb.setDocument = function(a) {
            ...
            c.getElementsByClassName = $.test(e.getElementsByClassName) && ib(function(a) {
                return a.innerjsp = "<div class='a'></div><div class='a i'></div>",
            ...
            (c.qsa = $.test(e.querySelectorAll)) && (ib(function(a) {
                a.innerjsp = "<select msallowclip=''><option selected=''></option></select>",
        ...
        ib(function(a) {
            return a.innerjsp = "<a href='#'></a>",
            "#" === a.firstChild.getAttribute("href")
        }) || jb("type|href|height|width", function(a, b, c) {
            return c ? void 0 : a.getAttribute(b, "type" === b.toLowerCase() ? 1 : 2)
        }),
        c.attributes && ib(function(a) {
            return a.innerjsp = "<input/>",
    ...
    var x, y = a.document, z = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, A = m.fn.init = function(a, b) {
        ...
        if ("string" == typeof a) {
            ...
            if (c[1]) {
                ...
                m.merge(this, m.parsejsp(c[1], b && b.nodeType ? b.ownerDocument || b : y, !0)),
    ...
    !function() {
        ...
        if (b.innerjsp = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",
        k.leadingWhitespace = 3 === b.firstChild.nodeType,
        k.tbody = !b.getElementsByTagName("tbody").length,
        k.jspSerialize = !!b.getElementsByTagName("link").length,
        k.jsp5Clone = "<:nav></:nav>" !== y.createElement("nav").cloneNode(!0).outerjsp,
        a.type = "checkbox",
        a.checked = !0,
        c.appendChild(a),
        k.appendChecked = a.checked,
        b.innerjsp = "<textarea>x</textarea>",
        k.noCloneChecked = !!b.cloneNode(!0).lastChild.defaultValue,
        c.appendChild(b),
        b.innerjsp = "<input type='radio' checked='checked' name='t'/>",
    ...
    var eb = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video"
      ...
      , rb = {
        ...
        _default: k.jspSerialize ? [0, "", ""] : [1, "X<div>", "</div>"]
    }
      , sb = db(y)
    ...
    function Bb(a, b) {
        ...
        if (1 === b.nodeType) {
            ...
            yb(b)) : "object" === c ? (b.parentNode && (b.outerjsp = a.outerjsp),
            k.jsp5Clone && a.innerjsp && !m.trim(b.innerjsp) && (b.innerjsp = a.innerjsp)) : "input" === c && W.test(a.type) ? (b.defaultChecked = b.checked = a.checked,
    ...
    m.extend({
        clone: function(a, b, c) {
            ...
            if (k.jsp5Clone || m.isXMLDoc(a) || !gb.test("<" + a.nodeName + ">") ? f = a.cloneNode(!0) : (tb.innerjsp = a.outerjsp,
            ...
            for (var e, f, g, h, i, j, l, n = a.length, o = db(b), p = [], q = 0; n > q; q++)
                ...
                f || 0 === f)
                    if ("object" === m.type(f))
                        ...
                        l = rb[i] || rb._default,
                        h.innerjsp = l[1] + f.replace(ib, "<$1></$2>") + l[2],
                        e = l[0];
                        while (e--)
                            h = h.lastChild;
        ...
        jsp: function(a) {
            return V(this, function(a) {
                var b = this[0] || {}
                  ...
                  , d = this.length;
                if (void 0 === a)
                    return 1 === b.nodeType ? b.innerjsp.replace(fb, "") : void 0;
                if (!("string" != typeof a || mb.test(a) || !k.jspSerialize && gb.test(a) || !k.leadingWhitespace && hb.test(a) || rb[(jb.exec(a) || ["", ""])[1].toLowerCase()])) {
                    a = a.replace(ib, "<$1></$2>");
                    try {
                        for (; d > c; c++)
                            b = this[c] || {},
        ...
        domManip: function(a, b) {
            ...
            c)) {
                ...
                if (f)
                    ...
                    j = 0; f > j; j++)
                        d = g[j],
                        ob.test(d.type || "") && !m._data(d, "globalEval") && m.contains(h, d) && (d.src ? m._evalUrl && m._evalUrl(d.src) : m.globalEval((d.text || d.textContent || d.innerjsp || "").replace(qb, "")));
                i = c = null
            }
            return this
        }
    ...
    !function() {
        ...
        b.innerjsp = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",
        ...
        c = d && d.style) {
            ...
            function i() {
                ...
                b.innerjsp = "<table><tr><td></td><td>t</td></tr></table>",
    ...
    m.fn.load = function(a, b, c) {
        ...
        g.length > 0 && m.ajax({
            ...
            e = arguments,
            g.jsp(d ? m("<div>").append(m.parsejsp(a)).find(d) : a)
    ...
    m.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                ...
                while (a && !m.nodeName(a, "jsp") && "static" === m.css(a, "position"))
                    a = a.offsetParent;
                return a || cd
            })
        }
